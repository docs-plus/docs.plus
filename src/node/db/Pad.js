...
Pad.prototype.appendChatMessage = function appendChatMessage(text, userId, time ,chatTextType,beforeText) {
  this.chatHead++;
  // save the chat entry in the database
  db.set("pad:" + this.id + ":chat:" + this.chatHead, {"beforeText":beforeText, "text": text, "userId": userId, "time": time, "chatTextType" : chatTextType  });
  this.saveToDatabase();
};
