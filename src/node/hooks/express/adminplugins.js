...
var installer = require('/app/src/static/js/pluginfw/installer');
...
exports.expressCreateServer = function(hook_name, args, cb) {
  args.app.get('/admin/plugins', function(req, res) {
    ...
    res.send(eejs.require("/app/src/templates/admin/plugins.html", render_args));
  });
  ...
  args.app.get('/admin/plugins/info', function(req, res) {
    ...
    res.send(eejs.require("/app/src/templates/admin/plugins-info.html", {
      gitCommit: gitCommit,
      epVersion: epVersion
    }));
  });
