...
| File         | Source                                                                                 | License                                                   |
| ------------ | -------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| `sample.jpg` | Maintainer-supplied demo art                                                           | README gallery only                                       |
| `sample.mp4` | [Big Buck Bunny](https://peach.blender.org/) © Blender Foundation                      | [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/) |
