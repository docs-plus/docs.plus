...
import { LuCircle, LuRadio, LuFileText } from 'react-icons/lu';
...
export default function UsersPage() {
  ...
  const {
    ...
    setSearch,
    handleSort,
  } = useTableParams({ defaultSortKey: 'created_at', defaultSortDirection: 'desc' });
    ...
    },
    {
      ...
      render: (user: UserWithDocs) => (
        <div className="flex items-center gap-1.5">
          <LuFileText className="h-4 w-4 text-base-content/40" />
