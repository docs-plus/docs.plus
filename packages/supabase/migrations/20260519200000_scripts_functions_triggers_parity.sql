...
-- >>> begin 07-1-notification-functions.sql
/*
...
-- <<< end 07-1-notification-functions.sql

-- >>> begin 07-3-notification-broadcast.sql
-- -----------------------------------------------------------------------------
...
-- <<< end 07-3-notification-broadcast.sql

-- >>> begin 07-4-push-notifications-pgmq.sql
-- -----------------------------------------------------------------------------
...
-- <<< end 07-4-push-notifications-pgmq.sql

-- >>> begin 07-5-email-notifications-pgmq.sql
-- =============================================================================
...
-- <<< end 07-5-email-notifications-pgmq.sql

-- >>> begin 07-bookmark-functions.sql
...
-- <<< end 07-bookmark-functions.sql

-- >>> begin 09-message_counter.sql
/****************************************************************************
...
DROP TRIGGER IF EXISTS trigger_on_message_insert ON public.messages;
...
DROP TRIGGER IF EXISTS trigger_on_message_delete ON public.messages;
...
DROP TRIGGER IF EXISTS trigger_on_message_soft_delete ON public.messages;
...
-- <<< end 09-message_counter.sql

-- >>> begin 10-0-func-helpers.sql
/*
 * Helper Functions
...
DROP TRIGGER IF EXISTS trigger_update_user_online_at ON public.users;
...
-- <<< end 10-1-func-users.sql

-- >>> begin 10-2-func-channels.sql
/*
...
DROP TRIGGER IF EXISTS channel_creator_as_admin ON public.channels;
...
DROP TRIGGER IF EXISTS increment_member_count ON public.channel_members;
...
DROP TRIGGER IF EXISTS decrement_member_count ON public.channel_members;
...
DROP TRIGGER IF EXISTS check_duplicate_member ON public.channel_members;
...
-- <<< end 10-2-func-channels.sql

-- >>> begin 10-3-func-message.sql
/*
...
-- <<< end 10-5-func-replied_msg.sql

-- >>> begin 10-7-func-pinned.sql
/*
...
DROP TRIGGER IF EXISTS set_message_pinned_status ON public.pinned_messages;
...
DROP TRIGGER IF EXISTS clear_message_pinned_status ON public.pinned_messages;
...
DROP TRIGGER IF EXISTS track_channel_activity_on_pin ON public.pinned_messages;
...
-- <<< end 10-7-func-pinned.sql

-- >>> begin 10-8-func-workspace_members.sql
...
-- <<< end 10-8-func-workspace_members.sql

-- >>> begin 10-func-notifications.sql
...
DROP TRIGGER IF EXISTS create_reaction_notifications ON public.messages;
...
DROP TRIGGER IF EXISTS increment_unread_count ON public.messages;
...
-- <<< end 10-func-notifications.sql

-- >>> begin 10-functions.sql
-- Test
...
-- <<< end 10-functions.sql

-- >>> begin 22-user-retention.sql
-- =============================================================================
