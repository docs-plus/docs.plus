            ...
            doc.descendants((node, pos) => {
              ...
              if ((hasAnchor || !this.options.showOnlyCurrent) && isEmpty) {
                ...
                console.log({
                  node,
                  isEmpty,
                  isNodeEmpty: isNodeEmpty(node),
                  isLeaf: node.isLeaf,
                  isEmptyDoc: isEmptyDoc,
                  hasAnchor: hasAnchor,
                  showOnlyCurrent: this.options.showOnlyCurrent,
                  showOnlyWhenEditable: this.options.showOnlyWhenEditable,
                  active: active
                })
