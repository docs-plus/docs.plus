...
const FormatSelection = ({ isVisible, editor }: { isVisible: boolean; editor: Editor }) => {
  return (
    <div
      className={`tiptap-toolbar-mobile__format-selection bg-base-100 absolute top-0 left-0 z-0 w-full space-y-6 rounded-t-3xl px-4 py-6 transition-all ${
        isVisible
          ? 'block -translate-y-[134px] shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1),_0_-2px_4px_-1px_rgba(0,0,0,0.06)]'
