...
const EditorContent = () => {
  ...
  if (loadingHistory || !editor) {
    return (
      <div className="editorWrapper bg-base-100 flex h-full grow items-start justify-center overflow-y-auto border-t-0 p-6">
  ...
  return (
    <div className="editorWrapper bg-base-100 flex h-full grow items-start justify-center overflow-y-auto border-t-0 p-0 sm:py-4">
      <TiptapEditorContent
        editor={editor}
