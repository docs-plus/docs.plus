  ...
  sections: [
    ...
    section(TEST_TITLE.medium, [
      ...
      heading(2, 'Special Level 2 Heading', [
        paragraph(TEST_CONTENT.short),
        heading(4, 'Special Level 3 Heading', [
          paragraph(TEST_CONTENT.short),
          heading(5, 'Special Level 4 Heading', [
            paragraph(TEST_CONTENT.short),
            heading(6, 'Special Level 5 Heading', [
              paragraph(TEST_CONTENT.short),
              heading(7, 'Special Level 6 Heading', [paragraph(TEST_CONTENT.short)])
            ])
          ])
        ]),
        heading(3, 'Special Level 3 Heading', [paragraph(TEST_CONTENT.short)])
