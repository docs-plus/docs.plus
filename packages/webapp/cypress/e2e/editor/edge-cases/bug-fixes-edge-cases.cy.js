...
const pasteHTML = (html) => {
  ...
  cy.wait(500) // allow plugins to settle
}
...
describe('Heading Schema Production Readiness — Comprehensive E2E', () => {
  ...
  describe('3. Heading Level Change', () => {
    ...
    it('3.4 Backward change H3→H2 (promotion)', () => {
      cy.createDocument([
        section('Root', [heading(2, 'Parent H2', [heading(3, 'Child H3', [paragraph('h3 body')])])])
      ])
      cy.wait(300)
  ...
  describe('5. Clipboard Paste', () => {
    ...
    it('5.7 Paste deep hierarchy (H2→H3→H4→H5) at shallow level', () => {
      ...
      clickContentArea(1)
      pasteHTML('<h2>L2</h2><p>c2</p><h3>L3</h3><p>c3</p><h4>L4</h4><p>c4</p><h5>L5</h5><p>c5</p>')
      waitForPlugin()
