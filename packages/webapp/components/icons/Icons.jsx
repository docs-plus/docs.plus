...
export const AddCommentMD = ({ size = 18, fill = 'black', className = '' }) => `
    <svg stroke="currentColor"
     class="${className}"
        fill="${fill}"
        width="${size}"
        strokeWidth="0" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
...
export const ArrowDownSVG = ({ size = 18, fill = '#fff', className = '' }) => {
  return `
  <svg viewBox="0 0 24 24" width=${size} class=${className} xmlns="http://www.w3.org/2000/svg">
      <path
        fill=${fill}
