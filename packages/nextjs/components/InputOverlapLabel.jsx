...
const InputOverlapLabel = forwardRef(({ label, value = '', id = new Date()
  ...
  const iconContainerClasses =
    'border-r w-12 flex align-middle justify-center items-center'
  ...
  return (
    <div className={containerClasses}>
      ...
      <input
        ...
        onChange={onChange}
        placeholder=" "
        className="block p-2 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
        {...props}
      />
