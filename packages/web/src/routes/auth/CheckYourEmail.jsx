    ...
    <div className='h-screen max-w-5xl m-auto flex flex-col justify-center  p-4'>
      <div className="bg-white w-[30rem] p-4 rounded-md shadow text-center">
        ...
        <div className="bg-green-200 m-auto w-12 h-12 flex items-center rounded-full justify-center text-white">
          <svg className="fill-current text-green-600" height="24" viewBox="0 0 24 24" width="24">
        ...
        <Link className='bg-indigo-600 block w-full text-sm text-center text-white hover:text-white font-light rounded-md px-4 py-2 hover:bg-indigo-700' to="/">
          Go back to Home
        </Link>
