...
| State                        | Recipe                                                                                                                                                                                                                                                                                                                                                                                       |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| frame                        | shared `TocRow` inside `ul.toc__list.menu` (after sticky `li.toc__header`): daisyUI menu owns item grid / `px-3 py-1.5` / type / `rounded-field` / hover / nest rails (stock); three children — leading (grip/fold) \| title `<a>` \| `TocRowTrail` end slot; `align-items: flex-start` only (wrap titles — menu defaults to center); `min-h-8` (mobile `min-h-11`); `--toc-list-inset:16px` |
