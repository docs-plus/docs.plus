...
| idle / hover / active | idle `text-base-content/70`; hover fill `color-mix(in oklch, var(--color-base-content) 10%, transparent)` + ink `text-base-content`; active/pressed fill `color-mix(in oklch, var(--color-base-content) 16%, transparent)` — visibly stronger than hover                                                |
| focus-visible         | `focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none`                                                                                                                                                                                                                            |
| why base-content mix  | not `bg-base-300` — the chatroom close sits on `bg-base-200`, modal/popover headers sit on `bg-base-100`; a fixed `base-300` only reads on one ground, the mix reads on both across all seven themes                                                                                                    |
