 ...
 * chat pane expands, and a fixed band then covers the whole container, so every
 * candidate matches and the scroll branches fight. A quarter leaves at least half the
 * container between the top and bottom bands. Sign is preserved for negative bands.
 */
