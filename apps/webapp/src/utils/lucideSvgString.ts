...
// Icon components are module-stable and render identical markup per size. The
// server-render cost is therefore paid once, and every later toolbar build is a cache hit.
