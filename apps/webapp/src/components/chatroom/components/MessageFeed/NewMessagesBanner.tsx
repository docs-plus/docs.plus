...
export const NewMessagesBanner = ({ count, sinceIso, onMarkAsRead }: NewMessagesBannerProps) => {
  ...
  return (
    <div
      className="border-base-300 bg-primary text-primary-content relative z-30 flex shrink-0 items-center justify-between gap-3 border-b px-3 py-2 text-sm motion-safe:animate-[doc-region-in_200ms_ease-out_both]"
      role="status"
      aria-live="polite">
