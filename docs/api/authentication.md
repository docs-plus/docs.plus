...
**A user token, required.** Listing your own documents, creating a document, the whole document lifecycle — delete, restore, duplicate, permanently delete, empty the trash — and uploading media.
